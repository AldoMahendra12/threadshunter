  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-[#2D3148] bg-[#1A1D27] px-8 py-6 md:w-[450px]"
            key={item.name}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] font-bold text-gray-100">
                    {item.name}
                  </span>
